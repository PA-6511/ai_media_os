...
def write_phase68_preparation_review_report(payload: dict, output_path: str) -> dict:
    ...
    report = {
        "phase": "68",
        "report_type": "limited_dry_run_preparation_review_package_report",
