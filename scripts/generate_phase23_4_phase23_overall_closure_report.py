#!/usr/bin/env python3
"""Generate Phase 23-4 report for overall Phase 23 closure."""
...
INPUT_FILES = {
    "23-1": "phase23_1_final_no_go_state_reconfirmation_report.json",
    "23-2": "phase23_2_continued_stop_without_human_go_report.json",
    "23-3": "phase23_3_pre_production_final_signoff_design_report.json",
}

DEFAULT_OUTPUT_JSON = LOG_DIR / "phase23_4_phase23_overall_closure_report.json"
DEFAULT_OUTPUT_MD = LOG_DIR / "phase23_4_phase23_overall_closure_report.md"
...
def abort_result(reason: str, output_json: Path) -> dict:
    result = {
        "package_type": "phase23_4_phase23_overall_closure_report",
        "phase": "Phase 23-4",
        "status": "ABORT",
        "reason": reason,
        "phase23_overall_closure_status": "ABORT",
...
def build_report(reports: dict[str, dict]) -> dict:
    return {
        "package_type": "phase23_4_phase23_overall_closure_report",
        "phase": "Phase 23-4",
        "title": "Phase 23-4 Phase 23 Overall Closure Report",
        "status": "PASS",
        "phase23_overall_closure_status": "PASS",
        "phase23_overall_status": "PASS",
        "phase_range": "Phase 23-1 through Phase 23-3",
        "execute_live_executed": False,
        "current_decision": "KEEP_NO_GO",
        "publish_candidate_unlocked_for_operator": False,
        "wordpress_publish_execution": "NO_GO",
        ...
        "target_draft_status": "draft",
        "phase_statuses": {
            phase: reports[phase].get("status") for phase in ["23-1", "23-2", "23-3"]
        },
        "still_forbidden": STILL_FORBIDDEN,
        "summary": {
            "phase23_closed_without_execute_live": True,
            "phase23_no_go_boundary_maintained": True,
            "phase24_can_start_from_formal_closure": True,
        },
        "next_step": "phase24_readiness_review_or_start_conditions",
        "created_at": datetime.now(timezone.utc).isoformat(),
    }
...
def build_markdown(report: dict) -> str:
    lines = [
        "# Phase 23-4 Phase 23 Overall Closure Report",
        "",
        f"Generated: {report['created_at']}",
        "",
        f"- status: {report['status']}",
        f"- phase23_overall_closure_status: {report['phase23_overall_closure_status']}",
...
def generate_report(logs_dir: Path, output_json: Path, output_md: Path) -> dict:
    ...
    return {
        "package_type": "phase23_4_phase23_overall_closure_report_result",
        "phase": "Phase 23-4",
        "status": report["status"],
        "phase23_overall_closure_status": report["phase23_overall_closure_status"],
        "phase23_overall_status": report["phase23_overall_status"],
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate Phase 23-4 overall closure report")
