...
FAILED_STAGING_REL="exchange/review_evidence/slack_worker_release_rebinding/slack-worker-CANDIDATE-NOT-APPROVED-01ba8809f133/tst-5d-w2b-i2e-baseline-absorption-rereview-20260725T141632/.i2f3e-j-root-deployment-final-execution-approval-packet-preparation-and-seal-staging-20260726T102320Z-537656"
FAILED_STAGING_ROOT="${REPO_ROOT}/${FAILED_STAGING_REL}"

RUN_ID="$(date -u +%Y%m%dT%H%M%SZ)-$$"
FINAL_PREFIX="i2f3e-j-root-deployment-final-execution-approval-packet-r1-staging-lifecycle-correction-preparation-and-seal"
...
test -d "$FAILED_STAGING_ROOT"
test ! -L "$FAILED_STAGING_ROOT"
test ! -e "$FINAL_ROOT"
test ! -L "$FINAL_ROOT"
test ! -e "$STAGING_ROOT"
test ! -L "$STAGING_ROOT"
...
FAILED_STAGING = Path(sys.argv[4]).resolve(strict=True)
STAGING_ARGUMENT = Path(sys.argv[5])
FINAL_ARGUMENT = Path(sys.argv[6])
FINAL_REL = sys.argv[7]

PHASE = (
    "TST-5D-W2B-I2F-3E-J-ROOT-DEPLOYMENT-"
    "FINAL-EXECUTION-APPROVAL-PACKET-R1-STAGING-LIFECYCLE-CORRECTION"
)

APPROVAL_TEXT = base64.b64decode("", validate=True)
MANUAL_TEXT = base64.b64decode("", validate=True)
PACKET_CONTRACT_BYTES = base64.b64decode(
    "",
    validate=True,
)
...
require(FAILED_STAGING.is_relative_to(REPO), "FAILED_STAGING_OUTSIDE_REPO")
...
failed_root_item = FAILED_STAGING.lstat()
require(stat.S_ISDIR(failed_root_item.st_mode), "FAILED_STAGING_NOT_DIRECTORY")
require(not stat.S_ISLNK(failed_root_item.st_mode), "FAILED_STAGING_SYMLINK")
require(stat.S_IMODE(failed_root_item.st_mode) == 0o750,
        "FAILED_STAGING_MODE")
require(failed_root_item.st_uid == 1001, "FAILED_STAGING_UID")
require(failed_root_item.st_gid == 1001, "FAILED_STAGING_GID")
require(failed_root_item.st_mtime_ns == 1785061400585610693,
        "FAILED_STAGING_MTIME_NS")
failed_files, failed_dirs, failed_links, failed_other = scan(FAILED_STAGING)
require(len(failed_files) == 0, "FAILED_STAGING_FILE_COUNT")
require(len(failed_dirs) == 0, "FAILED_STAGING_DIR_COUNT")
require(failed_links == 0, "FAILED_STAGING_LINK_COUNT")
require(failed_other == 0, "FAILED_STAGING_OTHER_COUNT")
failed_staging_identity_before = (
    stat.S_IMODE(failed_root_item.st_mode),
    failed_root_item.st_uid,
    failed_root_item.st_gid,
    failed_root_item.st_mtime_ns,
)

# Python is the sole staging creator in R1.
...
runner_source = execution_packet_root / "deployment-input-snapshot/runner-candidate"
...
for name, expected in RUNNER_PAYLOAD_SHA.items():
    require(sha256(runner_source / name) == expected,
            f"RUNNER_PAYLOAD_SHA:{name}")
...
failed_staging_inventory = {
    ...
    "failed_staging_relative_path":
        FAILED_STAGING.relative_to(REPO).as_posix(),
    "failed_staging_mode": "0750",
    "failed_staging_uid": 1001,
    "failed_staging_gid": 1001,
    "failed_staging_mtime_ns": 1785061400585610693,
    "failed_staging_file_count": 0,
    "failed_staging_directory_count_excluding_root": 0,
    "failed_staging_symlink_count": 0,
    "failed_staging_nonregular_count": 0,
    "final_evidence_candidate_count": 0,
    "readonly_inventory": "PASS",
    "failed_staging_mutation": False,
    "packet_generation_started_in_failed_attempt": False,
    "manifest_generation_started_in_failed_attempt": False,
    "seal_started_in_failed_attempt": False,
    "final_promotion_started_in_failed_attempt": False,
...
result = {
    ...
    "result": (
        ...
        "PACKET_R1_STAGING_LIFECYCLE_CORRECTION_"
        "PREPARED_AND_SEALED_NO_EXECUTION"
    ),
    "r1_staging_lifecycle_correction_only": True,
...
packet_manifest = {
    ...
    "phase": PHASE,
    "status": (
        "FINAL_EXECUTION_APPROVAL_PACKET_R1_STAGING_LIFECYCLE_"
...
require(len(new_files) == 18, f"NEW_EVIDENCE_FILE_COUNT:{len(new_files)}")
require(len(new_dirs) == 1, f"NEW_EVIDENCE_DIR_COUNT:{len(new_dirs)}")
require(len(packet_entries) == 15,
        f"NEW_PACKET_ENTRY_COUNT:{len(packet_entries)}")
require(len(evidence_lines) == 17,
...
require(len(new_packet_entries) == 15, "NEW_PACKET_MANIFEST_COUNT")
...
require(len(new_evidence_map) == 17, "NEW_EVIDENCE_MANIFEST_COUNT")
require(
...
failed_root_preseal = FAILED_STAGING.lstat()
require(
    (
        stat.S_IMODE(failed_root_preseal.st_mode),
        failed_root_preseal.st_uid,
        failed_root_preseal.st_gid,
        failed_root_preseal.st_mtime_ns,
    )
    == failed_staging_identity_before,
    "FAILED_STAGING_CHANGED_PRE_SEAL",
)
require(scan(FAILED_STAGING) == (set(), set(), 0, 0),
        "FAILED_STAGING_CONTENT_CHANGED_PRE_SEAL")
...
failed_root_postseal = FAILED_STAGING.lstat()
require(
    (
        stat.S_IMODE(failed_root_postseal.st_mode),
        failed_root_postseal.st_uid,
        failed_root_postseal.st_gid,
        failed_root_postseal.st_mtime_ns,
    )
    == failed_staging_identity_before,
    "FAILED_STAGING_CHANGED_POST_SEAL",
)
require(scan(FAILED_STAGING) == (set(), set(), 0, 0),
        "FAILED_STAGING_CONTENT_CHANGED_POST_SEAL")
for relative, expected in PROTECTED_SHA.items():
...
require(len(final_files) == 18, "FINAL_FILE_COUNT")
...
print("R1_STAGING_LIFECYCLE_CORRECTION_ONLY=true")
print("STAGING_CREATION_OWNER=PYTHON_ONLY")
print("SHELL_STAGING_MKDIR_REMOVED=true")
print(
    "FAILED_STAGING_ROOT="
    f"{FAILED_STAGING.relative_to(REPO).as_posix()}"
)
print("FAILED_STAGING_MODE=0750")
print("FAILED_STAGING_UID=1001")
print("FAILED_STAGING_GID=1001")
print("FAILED_STAGING_MTIME_NS=1785061400585610693")
print("FAILED_STAGING_FILE_COUNT=0")
print("FAILED_STAGING_DIRECTORY_COUNT_EXCLUDING_ROOT=0")
print("FAILED_STAGING_SYMLINK_COUNT=0")
print("FAILED_STAGING_NONREGULAR_COUNT=0")
...
print("NEW_EVIDENCE_FILE_COUNT=18")
print("NEW_EVIDENCE_DIRECTORY_COUNT_EXCLUDING_ROOT=1")
print("NEW_PACKET_MANIFEST_ENTRY_COUNT=15")
print("NEW_EVIDENCE_MANIFEST_ENTRY_COUNT=17")
