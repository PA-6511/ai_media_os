...
EVIDENCE_REL="${BASE_REL}/i2f3e-g-r1-gui-stop-restart-route-resolution-readonly-${RUN_ID}"
...
route_resolution = {
    ...
    "production_release_decision": "HOLD",
    "release_status": "CANDIDATE_NOT_APPROVED",
    "next_gate": "HUMAN_REVIEW_3E_G_R1_GUI_STOP_RESTART_ROUTE_PACKET",
}
...
semantic_validation = {
    "schema_version": "1.0",
    "phase": phase,
    "result": "PASS_3E_G_R1_GUI_STOP_RESTART_ROUTE_RESOLUTION_READONLY",
    "process_state": process_state,
    "matching_process_count": len(matches),
    "launch_origin_classification": launch_origin,
    "graceful_stop_method": stop_method,
...
packet_manifest = {
    ...
    "result": "PASS_3E_G_R1_GUI_STOP_RESTART_ROUTE_PACKET_GENERATED",
...
result = {
    ...
    "result": "PASS_W2B_I2F3E_G_R1_GUI_STOP_RESTART_ROUTE_RESOLUTION_READY",
...
print("CORRECTION_LABEL=PORTABLE_CP_NO_PRESERVE")
