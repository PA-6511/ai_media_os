...
require(
    packet_manifest["packet_file_count_excluding_manifest"] == 9,
...
require(len(packet_declared) == 9, "PACKET_DECLARED_COUNT_NOT_13")
require(
...
print("R2_R8_R2_PACKET_MANIFEST_ENTRY_COUNT=9")
print("R2_R8_R2_PACKET_MANIFEST_CONTENT_REVIEW=PASS")
print("R2_R8_R2_PACKET_MANIFEST_SCOPE=PACKET_SNAPSHOT_ONLY")
print("R2_R8_R2_VALIDATION_LOGS_IN_PACKET_MANIFEST=false")
print("R2_R8_R2_VALIDATION_LOGS_IN_EVIDENCE_MANIFEST=true")
...
PY
  ...
  echo "R2_R8_R2_PACKET_MANIFEST_ENTRY_COUNT=9"
  echo "R2_R8_R2_PACKET_MANIFEST_SCOPE=PACKET_SNAPSHOT_ONLY"
  echo "R2_R8_R2_VALIDATION_LOGS_IN_PACKET_MANIFEST=false"
  echo "R2_R8_R2_VALIDATION_LOGS_IN_EVIDENCE_MANIFEST=true"
