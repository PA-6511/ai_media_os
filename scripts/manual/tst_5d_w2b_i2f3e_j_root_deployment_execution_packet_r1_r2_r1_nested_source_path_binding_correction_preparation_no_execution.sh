...
FAILED_R1_R2_REL="${BASE_REL}/i2f3e-j-root-deployment-execution-packet-r1-r2-negative-test-call-selector-correction-preparation-20260726T065932Z-533653"
FAILED_R1_R2_ROOT="${REPO_ROOT}/${FAILED_R1_R2_REL}"
RUN_ID="$(date -u +%Y%m%dT%H%M%SZ)-$$"
NEW_REL="${BASE_REL}/i2f3e-j-root-deployment-execution-packet-r1-r2-r1-nested-source-path-binding-correction-preparation-${RUN_ID}"
...
PYTHONDONTWRITEBYTECODE=1 "$PYTHON_BIN" -B - \
  "$REPO_ROOT" "$SOURCE_ROOT" "$FAILED_R1_R2_ROOT" "$NEW_ROOT" "$NEW_REL" <<'PY'
...
failed_r1_r2_root = Path(sys.argv[3]).resolve(strict=True)
...
PHASE = "TST-5D-W2B-I2F-3E-J-ROOT-DEPLOYMENT-EXECUTION-PACKET-R1-R2-R1"
...
approval_text = base64.b64decode("", validate=True)
manual_text = base64.b64decode("", validate=True)
...
for relative, expected in REJECTED_INPUT_SHA.items():
    require(sha256(source_root / relative) == expected, f"REJECTED_INPUT_SHA:{relative}")
for relative, expected in PROTECTED_SHA.items():
    require(sha256(repo_root / relative) == expected, f"PROTECTED_SHA:{relative}")

failed_r1_r2_files, failed_r1_r2_dirs, failed_r1_r2_links, failed_r1_r2_other = scan(failed_r1_r2_root)
require(failed_r1_r2_links == 0 and failed_r1_r2_other == 0, "FAILED_R1_R2_SPECIAL")
failed_r1_r2_tree_sha, failed_r1_r2_inventory_files = source_tree_digest(failed_r1_r2_root)
failed_r1_r2_identity_before = complete_identity(failed_r1_r2_root)
...
registration_report = {
    "schema_version": "1.0",
    "phase": PHASE,
    "correction_scope": "NESTED_SOURCE_PATH_BINDING_ONLY",
    "prior_r1_r2_packet_preparation": "FAIL_SOURCE_PATH_BINDING",
    "prior_r1_r2_failure_stage": "SOURCE_NESTED_PATH_RESOLUTION",
    "failed_r1_r2_evidence_root": failed_r1_r2_root.relative_to(repo_root).as_posix(),
    "failed_r1_r2_file_count": len(failed_r1_r2_files),
    "failed_r1_r2_directory_count_excluding_root": len(failed_r1_r2_dirs),
    "failed_r1_r2_symlink_count": failed_r1_r2_links,
    "failed_r1_r2_nonregular_count": failed_r1_r2_other,
    "failed_r1_r2_tree_identity_sha256": failed_r1_r2_tree_sha,
    "failed_r1_r2_files": failed_r1_r2_inventory_files,
    "source_path_binding_before": "packet-snapshot/deployment-input-snapshot/rejected-execution-packet",
    "source_path_binding_after": "packet-snapshot/source-partial-evidence-snapshot/packet-snapshot/deployment-input-snapshot/rejected-execution-packet",
    "source_path_binding_corrected": True,
    ...
    "corrected_negative_test_sha256": sha256(candidate_root / "test_root_deployment_execution_packet_r1_negative.py"),
    "negative_test_changed_from_r1_r2_payload": False,
    "corrected_test_ids": [21, 26],
    "root_deployment_execution_allowed": False,
    "production_release_decision": "HOLD",
}
write_exclusive(
    packet_root / "selector-correction-report.json",
    (json.dumps(registration_report, sort_keys=True, indent=2) + "\n").encode(),
)
...
packet_manifest = {
    "schema_version": "1.0",
    "phase": PHASE,
    "status": "R1_R2_R1_NESTED_SOURCE_PATH_BINDING_CORRECTION_PACKET_PREPARED_NO_EXECUTION",
    "packet_file_count_excluding_manifest": 152,
    "packet_files": packet_entries,
    "candidate_artifact_count": 18,
    "source_partial_snapshot_file_count": 62,
    "prior_failed_r1_r2_registered": True,
    "source_path_binding_correction_only": True,
    "source_path_binding_corrected": True,
...
result = {
    "schema_version": "1.0",
    "phase": PHASE,
    "result": "PASS_W2B_I2F3E_J_ROOT_DEPLOYMENT_EXECUTION_PACKET_R1_R2_R1_NESTED_SOURCE_PATH_BINDING_CORRECTION_PREPARED_NO_EXECUTION",
    ...
    "prior_failed_r1_r2_evidence_root": failed_r1_r2_root.relative_to(repo_root).as_posix(),
    "prior_failed_r1_r2_file_count": len(failed_r1_r2_files),
    "prior_failed_r1_r2_directory_count_excluding_root": len(failed_r1_r2_dirs),
    "prior_failed_r1_r2_tree_identity_sha256": failed_r1_r2_tree_sha,
    "prior_failed_r1_r2_unchanged": True,
    "source_path_binding_correction_only": True,
    "source_path_binding_corrected": True,
    "corrected_source_base": "packet-snapshot/source-partial-evidence-snapshot",
    "corrected_rejected_execution_packet_base": "packet-snapshot/source-partial-evidence-snapshot/packet-snapshot/deployment-input-snapshot/rejected-execution-packet",
    "source_partial_snapshot_file_count": 62,
    "validator_target_file_count": 65,
    ...
    "production_release_decision": "HOLD",
    "release_status": "CANDIDATE_NOT_APPROVED",
    "next_gate": "HUMAN_REVIEW_3E_J_ROOT_DEPLOYMENT_EXECUTION_PACKET_R1_R2_R1_CORRECTION_READONLY",
}
...
require(complete_identity(failed_r1_r2_root) == failed_r1_r2_identity_before, "FAILED_R1_R2_CHANGED")
for relative, expected in PROTECTED_SHA.items():
...
print("RESULT=PASS_W2B_I2F3E_J_ROOT_DEPLOYMENT_EXECUTION_PACKET_R1_R2_R1_NESTED_SOURCE_PATH_BINDING_CORRECTION_PREPARED_NO_EXECUTION")
...
print(f"PRIOR_FAILED_R1_R2_EVIDENCE_ROOT={failed_r1_r2_root.relative_to(repo_root).as_posix()}")
print(f"PRIOR_FAILED_R1_R2_FILE_COUNT={len(failed_r1_r2_files)}")
print(f"PRIOR_FAILED_R1_R2_DIRECTORY_COUNT_EXCLUDING_ROOT={len(failed_r1_r2_dirs)}")
print(f"PRIOR_FAILED_R1_R2_TREE_IDENTITY_SHA256={failed_r1_r2_tree_sha}")
print("PRIOR_FAILED_R1_R2_UNCHANGED=true")
print("SOURCE_PATH_BINDING_CORRECTION_ONLY=true")
print("SOURCE_PATH_BINDING_CORRECTED=true")
print("CORRECTED_SOURCE_BASE=packet-snapshot/source-partial-evidence-snapshot")
print("CORRECTED_REJECTED_EXECUTION_PACKET_BASE=packet-snapshot/source-partial-evidence-snapshot/packet-snapshot/deployment-input-snapshot/rejected-execution-packet")
...
print("R1_R2_R1_CORRECTION_PACKET_PREPARATION_ONLY=true")
...
print("NEXT_GATE=HUMAN_REVIEW_3E_J_ROOT_DEPLOYMENT_EXECUTION_PACKET_R1_R2_R1_CORRECTION_READONLY")
