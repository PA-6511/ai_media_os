...
FINAL_PREFIX="i2f3e-j-root-deployment-final-execution-approval-packet-preparation-and-seal"
...
STAGING = Path(sys.argv[4]).resolve(strict=True)
FINAL = Path(sys.argv[5])
...
PHASE = (
    ...
    "FINAL-EXECUTION-APPROVAL-PACKET"
)

APPROVAL_TEXT = base64.b64decode("", validate=True)
MANUAL_TEXT = base64.b64decode("", validate=True)
PACKET_CONTRACT_BYTES = base64.b64decode(
    "",
    validate=True,
)
...
require(STAGING.is_relative_to(REPO), "STAGING_OUTSIDE_REPO")
require(
    FINAL.parent.resolve(strict=True) == STAGING.parent.resolve(strict=True),
    "FINAL_PARENT_MISMATCH",
)
require(not os.path.lexists(FINAL), "FINAL_PATH_ENTRY_EXISTS")
require(not os.path.lexists(STAGING), "STAGING_PATH_ENTRY_EXISTS")
...
result = {
    ...
    "phase": PHASE,
    "result": (
        "PASS_W2B_I2F3E_J_ROOT_DEPLOYMENT_"
        "FINAL_EXECUTION_APPROVAL_PACKET_PREPARED_AND_SEALED_NO_EXECUTION"
    ),
...
require(len(new_files) == 17, f"NEW_EVIDENCE_FILE_COUNT:{len(new_files)}")
require(len(new_dirs) == 1, f"NEW_EVIDENCE_DIR_COUNT:{len(new_dirs)}")
require(len(packet_entries) == 14,
        f"NEW_PACKET_ENTRY_COUNT:{len(packet_entries)}")
require(len(evidence_lines) == 16,
...
require(len(new_packet_entries) == 14, "NEW_PACKET_MANIFEST_COUNT")
...
require(len(new_evidence_map) == 16, "NEW_EVIDENCE_MANIFEST_COUNT")
require(
...
require(len(final_files) == 17, "FINAL_FILE_COUNT")
...
print(
    "RESULT=PASS_W2B_I2F3E_J_ROOT_DEPLOYMENT_"
    "FINAL_EXECUTION_APPROVAL_PACKET_PREPARED_AND_SEALED_NO_EXECUTION"
)
...
print("NEW_EVIDENCE_FILE_COUNT=17")
print("NEW_EVIDENCE_DIRECTORY_COUNT_EXCLUDING_ROOT=1")
print("NEW_PACKET_MANIFEST_ENTRY_COUNT=14")
print("NEW_EVIDENCE_MANIFEST_ENTRY_COUNT=16")
