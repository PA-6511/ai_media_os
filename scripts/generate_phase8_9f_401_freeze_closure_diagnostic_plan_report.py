...
DEFAULT_RESULT_JSON = ROOT / "exchange/logs/phase8_9f_401_freeze_closure_diagnostic_plan_result.json"
DEFAULT_REPORT_JSON = ROOT / "exchange/logs/phase8_9f_401_freeze_closure_diagnostic_plan_report.json"
DEFAULT_REPORT_MD = ROOT / "exchange/logs/phase8_9f_401_freeze_closure_diagnostic_plan_report.md"
...
def _build_markdown(report: dict[str, Any]) -> str:
    ...
    for path, status in report.get("previous_statuses", {}).items():
...
def generate_phase8_9f_401_freeze_closure_diagnostic_plan_report(
...
def main() -> int:
    report = generate_phase8_9f_401_freeze_closure_diagnostic_plan_report()
