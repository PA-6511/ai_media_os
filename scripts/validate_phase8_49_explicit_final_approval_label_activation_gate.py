...
DEFAULT_POLICY = ROOT / "config/phase8_49_explicit_final_approval_label_activation_gate_policy.json"
DEFAULT_REVIEW = ROOT / "exchange/human_review/phase8_49_explicit_final_approval_label_activation_gate.example.json"
DEFAULT_OUTPUT_JSON = ROOT / "exchange/logs/phase8_49_explicit_final_approval_label_activation_gate_result.json"
DEFAULT_OUTPUT_MD = ROOT / "exchange/logs/phase8_49_explicit_final_approval_label_activation_gate_result.md"
...
def _write_outputs(result: dict[str, Any], output_json_path: Path, output_md_path: Path) -> None:
    ...
    lines = [
        "# Phase 8-49 Explicit Final Approval Label Activation Gate Result",
        "",
...
def validate_phase8_49(
    ...
    for flag in [
        "label_activation_gate_is_execution_permission",
        "execution_allowed",
    ...
    if safety_violations:
        ...
        status = "FAIL"
    elif decision == "FINAL_LABEL_ACTIVATION_GATE_REVIEW_ONLY":
        status = "PHASE8_49_EXPLICIT_FINAL_APPROVAL_LABEL_ACTIVATION_GATE_PASS_NO_EXECUTION"
    elif decision == "REQUEST_FIX":
        status = "PHASE8_49_EXPLICIT_FINAL_APPROVAL_LABEL_ACTIVATION_GATE_REQUEST_FIX_NO_EXECUTION"
    elif decision == "REJECT":
        status = "PHASE8_49_EXPLICIT_FINAL_APPROVAL_LABEL_ACTIVATION_GATE_REJECTED_NO_EXECUTION"
    elif decision == "ABORT":
        status = "ABORT"
    else:
        status = "FAIL"

    if status == "PHASE8_49_EXPLICIT_FINAL_APPROVAL_LABEL_ACTIVATION_GATE_PASS_NO_EXECUTION":
...
def main() -> int:
    result = validate_phase8_49()
    print(json.dumps(result, ensure_ascii=False, indent=2))
    acceptable = {
        "PHASE8_49_EXPLICIT_FINAL_APPROVAL_LABEL_ACTIVATION_GATE_PASS_NO_EXECUTION",
        "PHASE8_49_EXPLICIT_FINAL_APPROVAL_LABEL_ACTIVATION_GATE_REQUEST_FIX_NO_EXECUTION",
        "PHASE8_49_EXPLICIT_FINAL_APPROVAL_LABEL_ACTIVATION_GATE_REJECTED_NO_EXECUTION",
        "FAIL",
    }
