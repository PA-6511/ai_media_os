...
DEFAULT_POLICY = ROOT / "config/phase8_44_final_one_shot_draft_creation_execution_preflight_policy.json"
DEFAULT_REVIEW = ROOT / "exchange/human_review/phase8_44_final_one_shot_draft_creation_execution_preflight.example.json"
DEFAULT_OUTPUT_JSON = ROOT / "exchange/logs/phase8_44_final_one_shot_draft_creation_execution_preflight_result.json"
DEFAULT_OUTPUT_MD = ROOT / "exchange/logs/phase8_44_final_one_shot_draft_creation_execution_preflight_result.md"
...
def validate_phase8_44(
    ...
    if not policy_path.exists():
        result = {
            ...
            "approval_label": None,
            "one_shot_lock_exists": None,
            "rollback_plan_defined": None,
            "freeze_plan_defined": None,
    ...
    if not review_path.exists():
        ...
        if approval_label_consumed:
            safety_violations.append("approval_label_consumed must be false in Phase 8-44")
        if review.get("wordpress_write_still_forbidden") is not True:
            safety_violations.append("wordpress_write_still_forbidden must be true")
    ...
    if safety_violations:
        ...
        result_status = "FAIL"
    elif decision == "FINAL_PREFLIGHT_READY_NO_EXECUTION":
        result_status = "PHASE8_44_FINAL_PREFLIGHT_READY_NO_EXECUTION"
    elif decision == "REQUEST_FIX":
        result_status = "PHASE8_44_FINAL_PREFLIGHT_REQUEST_FIX_NO_EXECUTION"
    elif decision == "REJECT":
        result_status = "PHASE8_44_FINAL_PREFLIGHT_REJECTED_NO_EXECUTION"
    elif decision == "ABORT":
        result_status = "ABORT"
    else:
        result_status = "FAIL"

    if result_status == "PHASE8_44_FINAL_PREFLIGHT_READY_NO_EXECUTION":
...
def main() -> int:
    result = validate_phase8_44()
    print(json.dumps(result, ensure_ascii=False, indent=2))
    acceptable = {
        "PHASE8_44_FINAL_PREFLIGHT_READY_NO_EXECUTION",
        "PHASE8_44_FINAL_PREFLIGHT_REQUEST_FIX_NO_EXECUTION",
        "PHASE8_44_FINAL_PREFLIGHT_REJECTED_NO_EXECUTION",
        "FAIL",
    }
