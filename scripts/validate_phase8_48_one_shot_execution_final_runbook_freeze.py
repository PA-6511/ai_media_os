...
DEFAULT_POLICY = ROOT / "config/phase8_48_one_shot_execution_final_runbook_freeze_policy.json"
DEFAULT_REVIEW = ROOT / "exchange/human_review/phase8_48_one_shot_execution_final_runbook_freeze.example.json"
DEFAULT_OUTPUT_JSON = ROOT / "exchange/logs/phase8_48_one_shot_execution_final_runbook_freeze_result.json"
DEFAULT_OUTPUT_MD = ROOT / "exchange/logs/phase8_48_one_shot_execution_final_runbook_freeze_result.md"
...
def _write_outputs(result: dict[str, Any], output_json_path: Path, output_md_path: Path) -> None:
    ...
    lines = [
        "# Phase 8-48 One-Shot Execution Final Runbook Freeze Result",
        "",
...
def validate_phase8_48(
    ...
    for flag in [
        "freeze_checkpoint_is_execution_permission",
        "execution_allowed",
    ...
    if safety_violations:
        ...
        status = "FAIL"
    elif decision == "FINAL_RUNBOOK_FREEZE_NO_EXECUTION":
        status = "PHASE8_48_ONE_SHOT_EXECUTION_FINAL_RUNBOOK_FREEZE_PASS_NO_EXECUTION"
    elif decision == "REQUEST_FIX":
        status = "PHASE8_48_ONE_SHOT_EXECUTION_FINAL_RUNBOOK_FREEZE_REQUEST_FIX_NO_EXECUTION"
    elif decision == "REJECT":
        status = "PHASE8_48_ONE_SHOT_EXECUTION_FINAL_RUNBOOK_FREEZE_REJECTED_NO_EXECUTION"
    elif decision == "ABORT":
        status = "ABORT"
    else:
        status = "FAIL"

    if status == "PHASE8_48_ONE_SHOT_EXECUTION_FINAL_RUNBOOK_FREEZE_PASS_NO_EXECUTION":
...
def main() -> int:
    result = validate_phase8_48()
    print(json.dumps(result, ensure_ascii=False, indent=2))
    acceptable = {
        "PHASE8_48_ONE_SHOT_EXECUTION_FINAL_RUNBOOK_FREEZE_PASS_NO_EXECUTION",
        "PHASE8_48_ONE_SHOT_EXECUTION_FINAL_RUNBOOK_FREEZE_REQUEST_FIX_NO_EXECUTION",
        "PHASE8_48_ONE_SHOT_EXECUTION_FINAL_RUNBOOK_FREEZE_REJECTED_NO_EXECUTION",
        "FAIL",
    }
