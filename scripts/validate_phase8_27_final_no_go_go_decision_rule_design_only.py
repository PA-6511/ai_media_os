...
DEFAULT_POLICY = ROOT / "config/phase8_27_final_no_go_go_decision_rule_design_only_policy.json"
DEFAULT_REQUEST = ROOT / "exchange/examples/phase8_27_final_no_go_go_decision_rule_design_only_request.example.json"
DEFAULT_OUTPUT = ROOT / "exchange/logs/phase8_27_final_no_go_go_decision_rule_design_only_result.json"
...
def main() -> int:
    result = validate_final_pre_execution_decision_phase(
        ...
        next_step_default="phase8_28_final_pre_execution_handoff_evidence_design_only",
        design_flags={
