...
DEFAULT_POLICY = ROOT / "config/phase8_41_manual_inspection_and_draft_evidence_review_policy.json"
DEFAULT_REVIEW = ROOT / "exchange/human_review/phase8_41_manual_inspection_and_draft_evidence_review.example.json"
DEFAULT_OUTPUT_JSON = ROOT / "exchange/logs/phase8_41_manual_inspection_and_draft_evidence_review_result.json"
DEFAULT_OUTPUT_MD = ROOT / "exchange/logs/phase8_41_manual_inspection_and_draft_evidence_review_result.md"
...
def validate_phase8_41(
    ...
    for flag in [
        "review_is_execution_permission",
        "execution_allowed",
    ...
    if safety_violations:
        ...
        result_status = "FAIL"
    elif decision == "REVIEW_COMPLETE_NO_EXECUTION_APPROVED":
        result_status = "PHASE8_41_MANUAL_INSPECTION_AND_DRAFT_EVIDENCE_REVIEW_PASS_NO_EXECUTION"
    elif decision == "REQUEST_FIX":
        result_status = "PHASE8_41_MANUAL_INSPECTION_REQUEST_FIX_NO_EXECUTION"
    elif decision == "REJECT":
        result_status = "PHASE8_41_MANUAL_INSPECTION_REJECTED_NO_EXECUTION"
    elif decision == "ABORT":
        result_status = "ABORT"
    else:
        result_status = "FAIL"

    if result_status == "PHASE8_41_MANUAL_INSPECTION_AND_DRAFT_EVIDENCE_REVIEW_PASS_NO_EXECUTION":
        allowed_next_step = policy.get("allowed_next_step_if_review_complete", "")
    else:
    ...
    result = {
        ...
        "wordpress_draft_created": False,
        "secret_values_output": False,
        "review_is_execution_permission": False,
...
def main() -> int:
    result = validate_phase8_41()
    print(json.dumps(result, ensure_ascii=False, indent=2))
    acceptable = {
        "PHASE8_41_MANUAL_INSPECTION_AND_DRAFT_EVIDENCE_REVIEW_PASS_NO_EXECUTION",
        "PHASE8_41_MANUAL_INSPECTION_REQUEST_FIX_NO_EXECUTION",
        "PHASE8_41_MANUAL_INSPECTION_REJECTED_NO_EXECUTION",
        "FAIL",
    }
