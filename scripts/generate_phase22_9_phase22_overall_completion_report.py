#!/usr/bin/env python3
"""Generate Phase 22-9 report for overall Phase 22 completion."""
...
DEFAULT_OUTPUT_JSON = LOG_DIR / "phase22_9_phase22_overall_completion_report.json"
DEFAULT_OUTPUT_MD = LOG_DIR / "phase22_9_phase22_overall_completion_report.md"
...
def abort_result(reason: str, output_json: Path) -> dict:
    result = {
        "package_type": "phase22_9_phase22_overall_completion_report",
        "phase": "Phase 22-9",
        "status": "ABORT",
        "reason": reason,
...
def validate_inputs(reports: dict[str, dict]) -> str | None:
    ...
    for phase in ["22-1", "22-2", "22-3", "22-4", "22-5", "22-6", "22-7", "22-8"]:
        data = reports[phase]
...
def build_report(reports: dict[str, dict]) -> dict:
    return {
        "package_type": "phase22_9_phase22_overall_completion_report",
        "phase": "Phase 22-9",
        "title": "Phase 22-9 Phase 22 Overall Completion Report",
        "status": "PASS",
        "phase22_overall_status": "PASS",
        "phase_range": "Phase 22-1 through Phase 22-8",
        "current_decision": "KEEP_NO_GO",
        "publish_candidate_unlocked_for_operator": False,
        "wordpress_publish_execution": "NO_GO",
        "wordpress_write_executed": False,
        ...
        "summary": {
            "phase22_completed_without_execute_live": True,
            "phase22_no_go_boundary_maintained": True,
            "phase23_start_conditions_can_be_designed": True,
        },
        "next_step": "phase23_1_start_conditions_check_design",
        "created_at": datetime.now(timezone.utc).isoformat(),
    }
...
def build_markdown(report: dict) -> str:
    lines = [
        "# Phase 22-9 Phase 22 Overall Completion Report",
        "",
        f"Generated: {report['created_at']}",
        "",
        f"- status: {report['status']}",
        f"- phase22_overall_status: {report['phase22_overall_status']}",
...
def generate_report(logs_dir: Path, output_json: Path, output_md: Path) -> dict:
    ...
    return {
        "package_type": "phase22_9_phase22_overall_completion_report_result",
        "phase": "Phase 22-9",
        "status": report["status"],
        "phase22_overall_status": report["phase22_overall_status"],
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate Phase 22-9 overall completion report")
