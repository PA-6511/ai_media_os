...
DEFAULT_POLICY = ROOT / "config/phase8_24_single_controlled_draft_creation_final_execution_authorization_design_only_policy.json"
DEFAULT_REQUEST = ROOT / "exchange/examples/phase8_24_single_controlled_draft_creation_final_execution_authorization_design_only_request.example.json"
DEFAULT_OUTPUT = ROOT / "exchange/logs/phase8_24_single_controlled_draft_creation_final_execution_authorization_design_only_result.json"
...
def main() -> int:
    result = validate_post_credentials_ready_design_phase(
        ...
        next_step_default="phase8_25_one_shot_execution_lock_rollback_post_run_evidence_design_only",
        design_flags={
