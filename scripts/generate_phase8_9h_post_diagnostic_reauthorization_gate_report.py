...
DEFAULT_RESULT_JSON = ROOT / "exchange/logs/phase8_9h_post_diagnostic_reauthorization_gate_result.json"
DEFAULT_REPORT_JSON = ROOT / "exchange/logs/phase8_9h_post_diagnostic_reauthorization_gate_report.json"
DEFAULT_REPORT_MD = ROOT / "exchange/logs/phase8_9h_post_diagnostic_reauthorization_gate_report.md"
...
def _build_markdown(report: dict[str, Any]) -> str:
    ...
    for key, value in report.get("diagnostic_reauth_conditions", {}).items():
    ...
    for key, value in report.get("operator_confirmations", {}).items():
        lines.append(f"- {key}: {value}")
...
def generate_phase8_9h_post_diagnostic_reauthorization_gate_report(
    ...
    if not result_json_path.exists():
        ...
        report = {
            ...
            "secret_values_written": False,
            "secret_values_logged": False,
            "diagnostic_reauth_conditions": result.get("diagnostic_reauth_conditions", {}),
            "operator_confirmations": result.get("operator_confirmations", {}),
...
def main() -> int:
    report = generate_phase8_9h_post_diagnostic_reauthorization_gate_report()
