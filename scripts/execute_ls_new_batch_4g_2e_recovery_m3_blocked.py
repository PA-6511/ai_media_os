...
result = {
    "phase_id": "LS-NEW-BATCH-4G-2E-RECOVERY-M3",
    "status": (
        "BLOCKED_ACTUAL_DMM_RECHECK_NEW_AUTH_"
        "CONSUMPTION_LINK_GENERATION_ARTICLE_"
        "PAYLOAD_AND_WORDPRESS_NOT_AUTHORIZED_IN_M3"
    ),
    "new_authorization_creation_allowed": True,
    "actual_dmm_recheck_allowed": False,
    "new_authorization_consumption_allowed": False,
