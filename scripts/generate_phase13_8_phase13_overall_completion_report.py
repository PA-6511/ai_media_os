#!/usr/bin/env python3
"""Generate Phase 13-8 report for overall Phase 13 completion."""
...
DEFAULT_OUTPUT_JSON = LOG_DIR / "phase13_8_phase13_overall_completion_report.json"
DEFAULT_OUTPUT_MD = LOG_DIR / "phase13_8_phase13_overall_completion_report.md"
...
def abort_result(reason: str, output_json: Path) -> dict:
    result = {
        "package_type": "phase13_8_phase13_overall_completion_report",
        "phase": "Phase 13-8",
        "status": "ABORT",
        "reason": reason,
...
def validate_inputs(reports: dict[str, dict]) -> str | None:
    ...
    for phase in ["13-1", "13-2", "13-3", "13-4", "13-5", "13-6", "13-7"]:
        data = reports[phase]
...
def build_report(reports: dict[str, dict]) -> dict:
    return {
        "package_type": "phase13_8_phase13_overall_completion_report",
        "phase": "Phase 13-8",
        "title": "Phase 13-8 Phase 13 Overall Completion Report",
        "status": "PASS",
        "phase13_overall_status": "PASS",
        "phase_range": "Phase 13-1 through Phase 13-7",
        "current_decision": "KEEP_NO_GO",
        "publish_candidate_unlocked_for_operator": False,
        "wordpress_publish_execution": "NO_GO",
        "wordpress_write_executed": False,
        ...
        "summary": {
            "phase13_completed_without_publish_execution": True,
            "phase13_no_go_boundary_maintained": True,
            "phase14_start_conditions_can_be_designed": True,
        },
        "next_step": "phase13_9_phase14_start_conditions_check_design",
        "created_at": datetime.now(timezone.utc).isoformat(),
    }
...
def build_markdown(report: dict) -> str:
    lines = [
        "# Phase 13-8 Phase 13 Overall Completion Report",
        "",
        f"Generated: {report['created_at']}",
        "",
        f"- status: {report['status']}",
        f"- phase13_overall_status: {report['phase13_overall_status']}",
...
def generate_report(logs_dir: Path, output_json: Path, output_md: Path) -> dict:
    ...
    return {
        "package_type": "phase13_8_phase13_overall_completion_report_result",
        "phase": "Phase 13-8",
        "status": report["status"],
        "phase13_overall_status": report["phase13_overall_status"],
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Generate Phase 13-8 overall completion report"
    )
