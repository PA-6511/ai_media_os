...
SCRIPT = ROOT / "scripts" / "generate_phase8_8_keep_no_go_completion_report.py"
OUT_JSON = ROOT / "exchange" / "logs" / "phase8_8_keep_no_go_completion_report.json"
OUT_MD = ROOT / "exchange" / "logs" / "phase8_8_keep_no_go_completion_report.md"
...
def test_script_exists():
    assert SCRIPT.exists(), "Phase 8-8 script not found"
...
def test_keep_no_go_core_values():
    d = _run()
    assert d.get("phase8_7_decision") == "KEEP_NO_GO"
