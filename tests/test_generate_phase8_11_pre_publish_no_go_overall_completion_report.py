...
SCRIPT = ROOT / "scripts" / "generate_phase8_11_pre_publish_no_go_overall_completion_report.py"
OUT_JSON = ROOT / "exchange" / "logs" / "phase8_11_pre_publish_no_go_overall_completion_report.json"
OUT_MD = ROOT / "exchange" / "logs" / "phase8_11_pre_publish_no_go_overall_completion_report.md"
...
def test_script_exists():
    assert SCRIPT.exists(), "Phase 8-11 script not found"
...
def test_keep_no_go_core_values():
    d = _run()
    assert d.get("phase8_overall_status") == "PASS"
    assert d.get("decision") == "KEEP_NO_GO"
