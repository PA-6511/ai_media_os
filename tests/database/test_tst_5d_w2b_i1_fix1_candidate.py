...
repository_module = _load_module(
    "tst_5d_w2b_i1_fix1_repository_candidate",
    CANDIDATE_ROOT / "workflow_state_repository_fix1_candidate.py",
)

migration_module = _load_module(
    "tst_5d_w2b_i1_fix1_migration_candidate",
    CANDIDATE_ROOT / "migration_fix1_candidate.py",
)
